...
// Forward declaration.
extern int VP8GetResidualCostMIPS_DSP(int ctx0, const VP8Residual* const res);

int VP8GetResidualCostMIPS_DSP(int ctx0, const VP8Residual* const res) {
...
void VP8EncDspInitMIPSdsp(void) {
