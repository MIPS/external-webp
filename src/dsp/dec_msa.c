...
#define IDCT_1D_W(in0, in1, in2, in3, out0, out1, out2, out3) {  \
  ...
  a1_m = in0 + in2;                                              \
  b1_m = in0 - in2;                                              \
  c_tmp1_m = SRAI_W((in1 * sinpi8sqrt2), 16);                    \
  c_tmp2_m = in3 + SRAI_W((in3 * cospi8sqrt2minus1), 16);        \
  c1_m = c_tmp1_m - c_tmp2_m;                                    \
  d_tmp1_m = in1 + SRAI_W((in1 * cospi8sqrt2minus1), 16);        \
  d_tmp2_m = SRAI_W((in3 * sinpi8sqrt2), 16);                    \
